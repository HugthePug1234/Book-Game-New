...
def add_character():
    ...
    try:
        ...
        logger.error(f"Error rendering character.html: {e}")
...
def set_details():
    ...
    try:
        ...
        logger.error(f"Error rendering details.html: {e}")
...
def book_display():
    ...
    try:
        ...
        return render_template("display.html", book_content=book_content)
    except Exception as e:
        logger.error(f"Error rendering display.html: {e}")
